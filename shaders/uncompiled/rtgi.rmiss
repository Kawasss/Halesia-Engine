...
layout(set = 0, binding = 5) uniform sampler2D transmittanceLUT;
layout(set = 0, binding = 6) uniform sampler2D latlongMap;
...
void main()
{
	...
	vec3 viewPos = viewPosBase + payload.origin * 0.000001;
	vec2 size = sceneData.viewportSize;

	vec3 sunDir = GetSunDir();
    vec3 rayDir = payload.direction;
