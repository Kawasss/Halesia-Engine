...
public:
	...
	static glm::vec3 GetColorFromMessage(const Message& message);
...
template<typename T> void Console::AddConsoleVariable(std::string variableName, T* variable, Access access)
{
